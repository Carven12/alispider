    ...
    def __getConn():
        ...
        if Mysql.__pool is None:
            __pool = PooledDB(creator=MySQLdb, mincached=1, maxcached=20,
                              host=Config.DB_HOST, port=Config.DB_PORT, user=Config.DB_USER, passwd=Config.DB_PWD,
                              db=Config.DB_NAME, use_unicode=False, charset=Config.DB_CHAR, cursorclass=DictCursor)
